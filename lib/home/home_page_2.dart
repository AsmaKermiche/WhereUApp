...
import 'package:whereuapp/notificatons/main.dart';
    ...
    return Stack(
      ...
      children: <Widget>[
        ...
        Positioned(
          ...
          right:5,
          child:button((){
            Navigator.of(context).push(MaterialPageRoute(builder: (context) =>SettingPages(group: selectedGroup)));} , Icons.notifications, Color(0xfff2e9db),
