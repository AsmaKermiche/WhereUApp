      ...
      child: Container(
        ...
        child: Column (
          children: <Widget>[
            ...
            Text( ' Veuillez utiliser votre adresse mail pour réinitialiser votre mot de passe ' , style:TextStyle( fontSize:15.0 , fontWeight:FontWeight.bold, color:Color(0xffe8652d )  ) ,
