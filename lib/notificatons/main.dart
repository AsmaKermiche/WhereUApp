        ...
        return Positioned(
         ...
         height : 70 , child:            RaisedButton(  
                    onPressed: () =>
                            ...
                            builder: (BuildContext context) => new Msg1Page(group: widget.group,),
                          )),
   ...
   Row( children: <Widget> [
         ...
         height : 70 , child:
           RaisedButton(  
                      onPressed: () =>
                              Navigator.of(context).push(new MaterialPageRoute(
                            builder: (BuildContext context) => new Msg2Page(group: widget.group,),
                          )),
                   padding :EdgeInsets.all(20.0),
                   color:  Colors.white,
                  shape:RoundedRectangleBorder(borderRadius:BorderRadius.circular(30.0),),
...
padding :EdgeInsets.all(20.0),                      onPressed: () =>
                            Navigator.of(context).push(new MaterialPageRoute(
                            builder: (BuildContext context) => new Msg3Page(group: widget.group,),
                          )),
   ...
   SizedBox( height: 15.0),
         ...
         height : 70 , child:    
          RaisedButton(  
                    onPressed: () =>
                              Navigator.of(context).push(new MaterialPageRoute(
                            builder: (BuildContext context) => new Msg4Page(group: widget.group,),
                          )),
                   padding :EdgeInsets.all(20.0),
                   color:  Colors.white,
                  shape:RoundedRectangleBorder(borderRadius:BorderRadius.circular(30.0),),
